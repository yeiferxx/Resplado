...
<body class="d-flex flex-column h-100">
    ...
    <div class="container py-3">
        ...
        <h2 class="text-center">Bovinos Registrados</h2>
        ...
        <div class="row justify-content-end">
            <div class="col-auto">
                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#nuevoModal"><i class="fa-solid fa-circle-plus"></i> Registrar nuevo bovino</a>
            </div>
        </div>
